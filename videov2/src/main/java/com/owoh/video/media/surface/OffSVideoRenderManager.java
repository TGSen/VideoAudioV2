 ...
 * 渲染管理器
 */
public final class OffSVideoRenderManager {


    private static class RenderManagerHolder {
        public static OffSVideoRenderManager instance = new OffSVideoRenderManager();
    }

    private OffSVideoRenderManager() {

    }

    public static OffSVideoRenderManager getInstance() {
