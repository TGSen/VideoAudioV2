...
import com.owoh.video.engine.ScaleType;
import com.owoh.video.engine.render.RenderIndex;
...
import static com.owoh.video.media.bean.VideoEffectTypeKt.EFFECT_TYPE_MULTI;
...
//    }
    ...
    public void removeDynamicColorFilter() {
        ...
        if (mVideoEffectType.getCurrentEffectType() == EFFECT_TYPE_MULTI) {
            removeDynamicColorMultiFilter();
        } else if (mVideoEffectType.getCurrentEffectType() == EFFECT_TYPE_SINGLE) {
