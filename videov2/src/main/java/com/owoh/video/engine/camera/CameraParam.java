package com.owoh.video.engine.camera;
...
import com.owoh.video.engine.AspectRatio;
import com.owoh.video.engine.GalleryType;
import com.owoh.video.OnGallerySelectedListener;
import com.owoh.video.OnPreviewCaptureListener;
...
public final class CameraParam {
    ...
    // 16:9的默认宽高(理想值)
    public static final int DEFAULT_16_9_WIDTH = 720;
    public static final int DEFAULT_16_9_HEIGHT = 1280;
    // 4:3的默认宽高(理想值)
