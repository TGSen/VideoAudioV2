package com.owoh.video.widget.sticker;//package com.owoh.video.widget.sticker;
//
...
// * @author wupanjie
// */
//public class SuperStickerView extends FrameLayout {
//
...
//            borderPaint.setStrokeWidth(ConvertUtils.dp2px(1));
...
//                ContextCompat.getDrawable(getContext(), R.mipmap.sticker_ic_scale_white_18dp),
//                BitmapStickerIcon.RIGHT_BOTOM);
//        zoomIcon.setIconEvent(new ZoomIconEvent());
//        BitmapStickerIcon flipIcon = new BitmapStickerIcon(
//                ContextCompat.getDrawable(getContext(), R.mipmap.sticker_ic_flip_white_18dp),
...
//
//    @NonNull
//    public SuperStickerView addSticker(@NonNull Sticker sticker) {
//        return addSticker(sticker, Sticker.Position.CENTER);
//    }
//
//    public SuperStickerView addSticker(@NonNull final Sticker sticker,
...
//
//    @NonNull
//    public SuperStickerView setLocked(boolean locked) {
//        this.locked = locked;
//        invalidate();
//        return this;
//    }
//
//    @NonNull
//    public SuperStickerView setMinClickDelayTime(int minClickDelayTime) {
...
//
//    @NonNull
//    public SuperStickerView setConstrained(boolean constrained) {
...
//
//    @NonNull
//    public SuperStickerView setOnStickerOperationListener(
...
//     * @param progress
//     */
//    public void setShowSticker(int progress) {
//        if (stickers == null) return;
//        int size = stickers.size();
//        for (int i = 0; i < size; i++) {
//            Sticker sticker = stickers.get(i);
//            if (sticker.getStartTime() > progress || sticker.getEndTime() < progress) {
//                sticker.setShow(false);
//            } else {
//                sticker.setShow(true);
//            }
//        }
//        postInvalidate();
//
