...
public class ShutterButtonV1 extends View {
    ...
    public ShutterButtonV1(Context context) {
        super(context);
        init();
    }

    public ShutterButtonV1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ShutterButtonV1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        // 设置外圆背景颜色
        mOuterBackgroundColor = getResources().getColor(R.color.shutter_blue_alpha);
        // 设置内圆背景
